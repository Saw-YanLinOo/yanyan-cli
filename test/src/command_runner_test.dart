...
import 'package:yanyan/src/command_runner.dart';
...
void main() {
  group('YanyanCommandRunner', () {
    late PubUpdater pubUpdater;
    late Logger logger;
    late YanyanCommandRunner commandRunner;
    ...
    setUp(() {
      ...
      commandRunner = YanyanCommandRunner(
        logger: logger,
    ...
    test('can be instantiated without an explicit analytics/logger instance',
        () {
      final commandRunner = YanyanCommandRunner();
